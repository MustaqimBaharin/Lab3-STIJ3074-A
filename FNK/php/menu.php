...
<body onload="loadCookies()">
    ...
    <div class="container-src-pr">
        <form action="../php/menu.php" method="get">
            <div class="row">
                <div class="column">
    ...
    foreach ($rows as $products) {
        ...
        echo "Available : " . ($products['prqty']) . " order/s</p>";
        echo "<a href='../php/menu.php?op=cart&prodid=$prodid'><i class='fa fa-cart-plus'  onclick='return cartDialog()' style='font-size:24px;color:dodgerblue'></i></a>";
        echo "</div>";
    }
    echo "</div>";
    echo "</div>";
